...
post '/payment-sheet' do
  ...
  ephemeralKey = Stripe::EphemeralKey.create({
    customer: customer['id'],
  }, {stripe_version: '2024-04-10', stripe_account: '{{CONNECTED_ACCOUNT_ID}}'})
  paymentIntent = Stripe::PaymentIntent.create({
    amount: 1099,
    currency: 'eur',
...
dependencies {
  ...
  implementation("com.stripe:financial-connections:22.1.0")
}
```
