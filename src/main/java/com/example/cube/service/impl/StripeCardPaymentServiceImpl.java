...
@Service
public class StripeCardPaymentServiceImpl implements StripeCardPaymentService {
    ...
    @Override
    @Transactional
    public PaymentIntentResponse createCardPaymentIntent(UUID userId, UUID cubeId, UUID memberId, Integer cycleNumber) {
    ...
    @Override
    @Transactional
    public void handleCardPaymentIntentSucceeded(String paymentIntentId) {
        try {
